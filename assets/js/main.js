...
(function($) {
	...
	// Stops animations/transitions until the page has ...
		...
		// ... loaded.
			$window.on('load', function() {
                $('p.copyright').find('year').text(new Date().getFullYear());
    ...
    // Image Carousel
    $('body').on('spa-reload', function() {
        $('.slideshow').each(function(_, elm) {
            var slideIndex = 0;
            var currentIndex = 0;
            ...
            interval = setInterval(showSlides, wait);
